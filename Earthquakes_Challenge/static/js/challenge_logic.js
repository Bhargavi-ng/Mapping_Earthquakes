...
// Deliverable 3 Instructions: Add a third map style to your earthquake map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  let majorEarthquakes = 'https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_day.geojson';
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json(plateBoundaries).then(function(data) {
    ...
    // Creating a GeoJSON layer with the retrieved data
    L.geoJson(data,{
      // set style of techtonic plate boundary lines
      style: {
          color: 'red',
          weight: 2
          },
